...
return [
    ...
    */
    ...
    'relying_party_id' => env('PASSKEYS_RELYING_PARTY_ID', (function () {
        $httpHost = isset($_SERVER['HTTP_HOST']) ? explode(':', $_SERVER['HTTP_HOST'])[0] : null;
        $appHost = parse_url(config('app.url'), PHP_URL_HOST);
        $host = $httpHost ?: $appHost;
        return in_array($host, ['127.0.0.1', '::1', null, '']) ? 'localhost' : $host;
    })()),
    ...
    */
    ...
    'throttle' => env('PASSKEYS_THROTTLE', 'throttle:60,1'),
