...
return [
    ...
    'test_form' => [
        ...
        'card_desc' => 'Includes input, select, select remote, date-time, textarea, range, switch, radio, checkbox, and filepond. Try adding rows, duplicating, editing values, then submit to test the PHP array payload via AJAX.',
        ...
        'supervisor_placeholder' => 'Search supervisor from API...',
    ],

    'select_remote' => [
        'title' => 'API-Driven Select Integration (<vibe:select.remote>)',
        'desc' => 'The <code>&lt;vibe:select.remote&gt;</code> component works seamlessly inside repeater rows. Newly added rows automatically instantiate independent select controls with asynchronous fetching, debounced search, and reliable array namespacing.',
        'preview_title' => 'Project Task Assignment Example (Select Remote)',
        'form_label' => 'Project Task Assignments',
        'form_desc' => 'Assign each dynamic task row to a user fetched asynchronously from your backend API.',
        'add_task' => 'Add New Task',
        'task_title' => 'Task / Feature Title',
        'task_placeholder' => 'e.g., Integrate Payment Gateway',
        'assignee' => 'Assignee (User API)',
        'assignee_placeholder' => 'Search user from database...',
        'priority' => 'Priority',
        'priority_placeholder' => 'Select priority',
        'due_date' => 'Due Date',
        'due_placeholder' => 'Select deadline...',
    ],
];
