...
return [
    ...
    'card' => [
        ...
        'desc' => 'The <code class="font-mono text-xs text-foreground">&lt;vibe:tabs&gt;</code> component can be seamlessly integrated with <code class="font-mono text-xs text-foreground">&lt;vibe:card&gt;</code> to craft clean, structured, and modular user interfaces. Below are 2 common implementations using <strong>rows</strong> (horizontal) and <strong>cols</strong> (vertical) layouts.',
        'rows_title' => '1. Card with Row Tabs (Layout Rows)',
        'rows_desc' => 'Tabs are nested inside a card beneath <code class="font-mono text-xs text-foreground">&lt;vibe:card.header&gt;</code> with a horizontal layout (<code class="font-mono text-xs text-foreground">layout="rows"</code>). Each tab panel encapsulates form fields using <code class="font-mono text-xs text-foreground">&lt;vibe:card.content&gt;</code> and action buttons within <code class="font-mono text-xs text-foreground">&lt;vibe:card.footer&gt;</code>.',
        'rows_preview_title' => 'Horizontal Card Tabs (Rows)',
        'rows_header_title' => 'User Account Settings',
        'rows_header_desc' => 'Manage your personal profile, security credentials, and notification preferences.',
        'rows_tab_profile' => 'Profile',
        'rows_tab_password' => 'Password',
        'rows_tab_notifications' => 'Notifications',
        'rows_profile_name' => 'Full Name',
        'rows_profile_email' => 'Email Address',
        'rows_profile_bio' => 'Short Bio',
        'rows_save_btn' => 'Save Changes',
        'rows_cancel_btn' => 'Cancel',
        'rows_password_current' => 'Current Password',
        'rows_password_new' => 'New Password',
        'rows_password_confirm' => 'Confirm New Password',
        'rows_password_btn' => 'Update Password',
        'rows_notif_email_label' => 'Email Notifications',
        'rows_notif_email_desc' => 'Receive emails regarding critical security events and product announcements.',
        'rows_notif_marketing_label' => 'Marketing Emails',
        'rows_notif_marketing_desc' => 'Stay informed about feature launches, promotional discounts, and monthly newsletters.',

        'cols_title' => '2. Card with Column Tabs (Layout Cols)',
        'cols_desc' => 'The entire navigation and pane content are encapsulated inside a single <code class="font-mono text-xs text-foreground">&lt;vibe:card&gt;</code> using a vertical side-by-side layout (<code class="font-mono text-xs text-foreground">layout="cols"</code>). The left column acts as a dedicated tab sidebar, while the right column displays rich panel content.',
        'cols_preview_title' => 'Vertical Card Tabs (Cols)',
        'cols_header_title' => 'Workspace Settings',
        'cols_header_desc' => 'Configure your organization profile, team members, and resource quotas.',
        'cols_tab_general' => 'General',
        'cols_tab_members' => 'Team Members',
        'cols_tab_billing' => 'Plan & Quotas',
        'cols_general_name' => 'Workspace Name',
        'cols_general_slug' => 'Workspace URL',
        'cols_general_desc_field' => 'Organization Description',
        'cols_save_workspace' => 'Save Workspace',
        'cols_member_1_role' => 'Owner',
        'cols_member_2_role' => 'Admin',
        'cols_invite_btn' => 'Invite New Member',
        'cols_plan_title' => 'Enterprise Plan Active',
        'cols_plan_desc' => 'Includes unlimited seats, real-time telemetry, and dedicated 99.9% SLA priority.',
        'cols_upgrade_btn' => 'Manage Subscription',
    ],
