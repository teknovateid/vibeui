...
return [
    ...
    'card' => [
        'title' => 'Integrasi dengan Komponen Card',
        'desc' => 'Komponen <code class="font-mono text-xs text-foreground">&lt;vibe:tabs&gt;</code> dapat diintegrasikan secara elegan dengan <code class="font-mono text-xs text-foreground">&lt;vibe:card&gt;</code> untuk menciptakan antarmuka yang terstruktur, rapi, dan modular. Berikut 2 contoh implementasi menggunakan tata letak <strong>rows</strong> (horizontal) dan <strong>cols</strong> (vertikal).',
        'rows_title' => '1. Card dengan Tabs Baris (Layout Rows)',
        'rows_desc' => 'Tabs diletakkan di dalam kartu di bawah <code class="font-mono text-xs text-foreground">&lt;vibe:card.header&gt;</code> dengan tata letak horizontal (<code class="font-mono text-xs text-foreground">layout="rows"</code>). Setiap panel tab membungkus isi formulir menggunakan <code class="font-mono text-xs text-foreground">&lt;vibe:card.content&gt;</code> dan tombol aksi di dalam <code class="font-mono text-xs text-foreground">&lt;vibe:card.footer&gt;</code>.',
        'rows_preview_title' => 'Card Tabs Horizontal (Rows)',
        'rows_header_title' => 'Pengaturan Akun Pengguna',
        'rows_header_desc' => 'Kelola informasi identitas, kredensial keamanan, dan preferensi notifikasi Anda.',
        'rows_tab_profile' => 'Profil',
        'rows_tab_password' => 'Kata Sandi',
        'rows_tab_notifications' => 'Notifikasi',
        'rows_profile_name' => 'Nama Lengkap',
        'rows_profile_email' => 'Alamat Email',
        'rows_profile_bio' => 'Bio Singkat',
        'rows_save_btn' => 'Simpan Perubahan',
        'rows_cancel_btn' => 'Batal',
        'rows_password_current' => 'Kata Sandi Saat Ini',
        'rows_password_new' => 'Kata Sandi Baru',
        'rows_password_confirm' => 'Konfirmasi Kata Sandi',
        'rows_password_btn' => 'Perbarui Kata Sandi',
        'rows_notif_email_label' => 'Notifikasi Email',
        'rows_notif_email_desc' => 'Terima email mengenai pembaruan produk dan aktivitas keamanan.',
        'rows_notif_marketing_label' => 'Email Pemasaran',
        'rows_notif_marketing_desc' => 'Dapatkan info promo, rilis fitur baru, dan buletin bulanan.',

        'cols_title' => '2. Card dengan Tabs Kolom (Layout Cols)',
        'cols_desc' => 'Seluruh sistem navigasi tab dan panel konten diringkas di dalam satu kontainer <code class="font-mono text-xs text-foreground">&lt;vibe:card&gt;</code> dengan tata letak vertikal (<code class="font-mono text-xs text-foreground">layout="cols"</code>). Kolom sisi kiri berfungsi sebagai bilah menu tab berbingkai, sedangkan kolom sisi kanan menyajikan konten panel secara leluasa.',
        'cols_preview_title' => 'Card Tabs Vertikal (Cols)',
        'cols_header_title' => 'Pengaturan Ruang Kerja',
        'cols_header_desc' => 'Konfigurasi profil tim, anggota kolaborator, dan kuota sumber daya ruang kerja Anda.',
        'cols_tab_general' => 'Umum',
        'cols_tab_members' => 'Anggota Tim',
        'cols_tab_billing' => 'Paket & Kuota',
        'cols_general_name' => 'Nama Ruang Kerja',
        'cols_general_slug' => 'URL Ruang Kerja',
        'cols_general_desc_field' => 'Deskripsi Organisasi',
        'cols_save_workspace' => 'Simpan Ruang Kerja',
        'cols_member_1_role' => 'Pemilik',
        'cols_member_2_role' => 'Admin',
        'cols_invite_btn' => 'Undang Anggota',
        'cols_plan_title' => 'Paket Enterprise Aktif',
        'cols_plan_desc' => 'Mendukung anggota tak terbatas, analitik real-time, dan prioritas SLA 99.9%.',
        'cols_upgrade_btn' => 'Kelola Paket Langganan',
    ],
