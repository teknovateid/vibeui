...
return [
    ...
    'form_modal' => [
        ...
        'field_role_placeholder' => 'Pilih peran...',
    ...
    'persist' => [
        ...
        'reset_toast' => 'Status modal persistence berhasil direset! Anda dapat mencobanya kembali.',
        ...
        'reload_tip' => '💡 <strong>Uji Coba:</strong> Jangan tutup modal ini, coba tekan tombol refresh browser (F5 / Ctrl+R). Modal akan otomatis tetap terbuka kembali!',
        ...
        'btn_understand' => 'Tutup & Simpan Status',
        'announcement_note' => 'Catatan Modal Pengumuman: Untuk membuat modal pengumuman yang langsung muncul di awal dan tidak pernah muncul lagi setelah ditutup, kombinasikan prop <code class="px-1.5 py-0.5 rounded bg-muted text-xs font-mono text-foreground">:show="true" :persist="true"</code>.',
    ],
    ...
    'props' => [
        ...
        'subcomponents' => [
            [
                ...
                'desc' => 'Bagian header atas modal dengan layout vertikal bawaan (flex-col), ukuran teks text-lg font-semibold, dan garis batas bawah (border-b).',
            ],
            [
                'name' => '<vibe:modal.content>',
                'desc' => 'Wadah isi konten utama dengan padding standar (p-6) dan kemampuan scroll vertikal otomatis (overflow-y-auto).',
            ],
            [
                'name' => '<vibe:modal.footer>',
                'desc' => 'Area aksi tombol di bagian bawah dengan flex layout rata kanan, garis batas atas (border-t), dan latar halus.',
            ],
            [
                'name' => '<vibe:modal.close>',
                'desc' => 'Tombol silang penutup modal yang memanggil fungsi Alpine close(). Sudah otomatis dirender di pojok kanan atas jika dismissibleButton aktif.',
            ],
        ],
        'th_prop' => 'Properti',
        'th_type' => 'Tipe',
        ...
        'items' => [
            ...
            [
                ...
                'type' => 'string',
                'default' => '\'default\'',
                'desc' => 'Varian tampilan visual kartu modal (\'default\', \'elevated\', \'outline\', \'flat\', \'container\').',
            ],
            [
                'name' => 'dismissible',
                'type' => 'bool',
                'default' => 'true',
                'desc' => 'Mengizinkan penutupan modal via klik pada backdrop luar dan tombol Escape.',
            ],
            [
                'name' => 'dismissibleButton',
                'type' => 'bool',
                'default' => 'true',
                'desc' => 'Menentukan apakah tombol silang penutup (X) di pojok kanan atas ditampilkan.',
            ],
            [
                'name' => 'show',
                'type' => 'bool',
                'default' => 'false',
                'desc' => 'Menentukan apakah modal langsung terbuka saat pertama kali dirender.',
            ],
            [
                'name' => 'persist',
                'type' => 'bool',
                'default' => 'false',
                'desc' => 'Menyimpan status buka/tutup modal ke LocalStorage browser sehingga tetap terbuka saat halaman direfresh jika belum ditutup.',
            ],
            [
                'name' => 'teleport',
                'type' => 'bool',
                'default' => 'true',
                'desc' => 'Memindahkan elemen modal ke tag <body> menggunakan x-teleport untuk mencegah stacking context clipping.',
            ],
            [
                'name' => 'containerClass',
                'type' => 'string',
                'default' => 'null',
                'desc' => 'Class CSS tambahan untuk kontainer modal terluar.',
            ],
            [
                'name' => 'backdropClass',
                'type' => 'string',
