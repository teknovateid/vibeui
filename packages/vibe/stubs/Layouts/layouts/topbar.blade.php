                ...
                <vibe:header class="border-none max-w-400 mx-auto">
                    ...
                    <vibe:header.actions>
                        <vibe:dropdown keyboard>
                            <x-slot:trigger>
                                <vibe:avatar size="sm" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=64&h=64&q=75" alt="Name" class="cursor-pointer" />
                            </x-slot:trigger>
