<div class="space-y-6 flex flex-col xl:flex-row items-start w-full gap-x-20">
    ...
    <form wire:submit.prevent="updatePassword" class="space-y-4 w-full">
        ...
        <div class="flex justify-end pt-2">
            <vibe:button type="submit" variant="primary" size="sm" class="cursor-pointer" wire:loading.attr="disabled" wire:target="updatePassword">
                <span wire:loading.remove wire:target="updatePassword">
                    {{ __('vibe/settings.security.update_password_btn') }}
                </span>
                <span wire:loading.inline-flex wire:target="updatePassword" class="inline-flex items-center justify-center gap-1.5 leading-none">
                    ...
                    <span>{{ __('vibe/settings.security.updating_password') }}</span>
                </span>
            </vibe:button>
        </div>
    </form>
