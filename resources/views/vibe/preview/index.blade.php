...
>
    ...
    <div class="relative flex items-center justify-between min-h-10.5 px-3.5 py-2 bg-muted/40 dark:bg-muted/20 border-b border-border text-xs">
        ...
        <div class="relative z-10 flex items-center gap-2 shrink-0">
            <div class="inline-flex items-center gap-0.5 p-0.5 rounded-lg bg-muted border border-border shadow-2xs select-none">
                <button
        ...
        <div class="relative z-10 flex items-center justify-end gap-1.5 shrink-0">
            ...
            @if ($viewports)
                <div
                    id="{{ $viewportGroupId }}"
                    x-show="tab === 'preview'"
                    class="hidden sm:inline-flex items-center gap-0.5 p-0.5 rounded-lg bg-muted border border-border shadow-2xs select-none"
                ...
                >
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $viewport === '100%' ? 'bg-background text-foreground shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $viewport === '768px' ? 'bg-background text-foreground shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $viewport === '375px' ? 'bg-background text-foreground shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
            ...
            @if ($themeSwitch)
                <div
                    id="{{ $themeGroupId }}"
                    x-show="tab === 'preview'"
                    class="inline-flex items-center gap-0.5 p-0.5 rounded-lg bg-muted border border-border shadow-2xs select-none"
                    style="{{ $tab === 'code' ? 'display: none;' : '' }}"
                >
                    {{-- Auto / System Mode --}}
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $canvasTheme === 'auto' ? 'bg-background text-foreground shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $canvasTheme === 'light' ? 'bg-background text-amber-500 shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
                    ...
                    <button
                        ...
                        class="inline-flex items-center justify-center size-7 rounded-md cursor-pointer focus:outline-none transition-all duration-150 {{ $canvasTheme === 'dark' ? 'bg-background text-indigo-400 shadow-xs ring-1 ring-border/80' : 'text-foreground/70 hover:text-foreground hover:bg-background/50' }}"
        ...
        try {
            ...
            if (item) {
                ...
                if (item.tab) {
                    ...
                    var activeTabClasses = ['bg-background', 'text-foreground', 'shadow-xs', 'font-semibold', 'ring-1', 'ring-border/80'];
                    var inactiveTabClasses = ['text-foreground/70', 'hover:text-foreground', 'hover:bg-background/50', 'font-medium'];
                ...
                if (item.viewport) {
                    ...
                    var activeVpClasses = ['bg-background', 'text-foreground', 'shadow-xs', 'ring-1', 'ring-border/80'];
                    var inactiveVpClasses = ['text-foreground/70', 'hover:text-foreground', 'hover:bg-background/50'];
                ...
                if (item.canvasTheme) {
                    ...
                    themeButtons.forEach(function(btn) {
                        ...
                        btn.classList.remove('bg-background', 'text-foreground', 'text-amber-500', 'text-indigo-400', 'shadow-xs', 'ring-1', 'ring-border/80', 'text-foreground/70', 'hover:bg-background/50');
                        if (t === item.canvasTheme) {
                            btn.classList.add('bg-background', 'shadow-xs', 'ring-1', 'ring-border/80');
                            ...
                            btn.classList.add('text-foreground/70', 'hover:text-foreground', 'hover:bg-background/50');
                        }
                    });
                }
            }
