...
<vibe:sheet id="demo-sheet-basic" position="right" behavior="collapsible" :defaultSize="320">
    ...
    <vibe:sheet.body class="space-y-3">
        <p class="text-sm text-muted-foreground">
                    ...
                    <div class="space-y-4">
                        <div class="flex flex-wrap items-center justify-center gap-2 p-2">
                            <vibe:button @click="$dispatch('toggle-sheet', 'demo-pos-left')" variant="outline" size="sm">
                                <svg class="size-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M19 12H5M12 19l-7-7 7-7"/></svg>
                                {{ __('docs/sheet.positions.btn_left') }}
                            </vibe:button>
                            <vibe:button @click="$dispatch('toggle-sheet', 'demo-pos-right')" variant="outline" size="sm">
                                <svg class="size-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M5 12h14M12 5l7 7-7 7"/></svg>
                                {{ __('docs/sheet.positions.btn_right') }}
                            </vibe:button>
                            <vibe:button @click="$dispatch('toggle-sheet', 'demo-pos-top')" variant="outline" size="sm">
                                <svg class="size-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 19V5M5 12l7-7 7 7"/></svg>
                                {{ __('docs/sheet.positions.btn_top') }}
                            </vibe:button>
                            <vibe:button @click="$dispatch('toggle-sheet', 'demo-pos-bottom')" variant="outline" size="sm">
                                <svg class="size-4 mr-1.5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14M19 12l-7 7-7-7"/></svg>
                                {{ __('docs/sheet.positions.btn_bottom') }}
                            </vibe:button>
                        </div>

                        {{-- Sandbox Container --}}
                        <div class="relative h-88 w-full overflow-hidden border border-border rounded-xl bg-muted/15 flex flex-col">
                            {{-- Top Sheet --}}
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative h-80 w-full overflow-hidden border border-border rounded-xl bg-muted/10 flex">
                            ...
                            >
                                ...
                                <vibe:sheet.body class="space-y-2">
...
<vibe:sheet 
    ...
    :minSize="140" 
    :maxSize="380" 
    class="rounded-t-3xl border-t border-x border-border shadow-2xl bg-card"
>
    ...
    <vibe:sheet.body class="px-5 py-2 space-y-1">
        <button type="button" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-muted/60 text-xs text-foreground font-medium transition-colors text-left">
            <svg class="size-4 text-primary shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12v8a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2v-8"/><polyline points="16 6 12 2 8 6"/><line x1="12" y1="2" x2="12" y2="15"/></svg>
            <span>{{ __('docs/sheet.bottom_sheet.item_share') }}</span>
        </button>
        <button type="button" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-muted/60 text-xs text-foreground font-medium transition-colors text-left">
            <svg class="size-4 text-info shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
            <span>{{ __('docs/sheet.bottom_sheet.item_download') }}</span>
        </button>
        <button type="button" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-muted/60 text-xs text-foreground font-medium transition-colors text-left">
            <svg class="size-4 text-warning shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m19 21-7-4-7 4V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v16z"/></svg>
        ...
        <button type="button" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl hover:bg-destructive/10 text-xs text-destructive font-medium transition-colors text-left">
            <svg class="size-4 text-destructive shrink-0" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18"/><path d="M19 6v14c0 1-1 2-2 2H7c-1 0-2-1-2-2V6"/><path d="M8 6V4c0-1 1-2 2-2h4c1 0 2 1 2 2v2"/></svg>
                        ...
                        <div class="max-w-xs mx-auto h-115 rounded-[2.5rem] border-4 border-muted-foreground/25 shadow-2xl bg-muted/20 relative overflow-hidden flex flex-col">
                            ...
                            <div class="h-10 shrink-0 px-6 flex items-center justify-between z-30 select-none pointer-events-none">
                                ...
                                <div class="flex items-center gap-1.5 text-foreground">
                                    <svg class="size-3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"><path d="M12 3c-4.97 0-9 4.03-9 9 0 2.12.74 4.07 1.97 5.61L12 22l7.03-4.39C20.26 16.07 21 14.12 21 12c0-4.97-4.03-9-9-9z"/></svg>
                                    <div class="w-4 h-2 rounded-xs border border-current flex items-center p-0.5"><div class="w-full h-full bg-current"></div></div>
                                </div>
                            </div>
                            ...
                            >
                                ...
                                <vibe:sheet.body class="px-5 py-1 space-y-1">
...
>
    ...
    <vibe:sheet.body class="space-y-1 p-2">
                            ...
                            >
                                ...
                                <vibe:sheet.body class="space-y-1 p-2">
                                    <a href="#mode-perilaku" class="flex items-center gap-3 p-2 rounded-lg bg-muted/60 text-foreground font-medium text-xs group-data-[state=minified]/sheet:justify-center">
                                        <svg class="size-4 shrink-0 text-primary" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg>
                                        <span class="group-data-[state=minified]/sheet:hidden">{{ __('docs/sheet.behaviors.nav_dashboard') }}</span>
                                    </a>
...
<div x-data="{ openDrawer: false }">
    ...
    <div 
        ...
        class="fixed inset-0 bg-black/50 backdrop-blur-xs z-30" 
        @click="openDrawer = false; $dispatch('close-sheet', 'demo-outside-backdrop')"
    ></div>

    <vibe:sheet 
        id="demo-outside-backdrop" 
        position="right" 
        layout="fixed" 
        behavior="collapsible" 
        defaultState="collapsed" 
        :closeOnOutsideClick="true" 
        :defaultSize="320"
        @close-sheet.window="openDrawer = false"
    >
        ...
    </vibe:sheet>
</div>
                    ...
                    <div class="space-y-4" x-data="{ backdropOpen: false }">
                        ...
                        <div class="relative h-88 w-full overflow-hidden border border-border rounded-xl bg-card flex">
                            ...
                            >
                                ...
                                <vibe:sheet.body class="space-y-2">
                                    ...
                                    <div class="p-2.5 rounded-lg bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-[11px] space-y-1">
                            ...
                            <div 
                                x-show="backdropOpen" 
                                x-transition.opacity 
                                class="absolute inset-0 bg-black/50 backdrop-blur-xs z-30 flex items-center justify-center p-4 cursor-pointer"
                                @click="backdropOpen = false; $dispatch('close-sheet', 'demo-outside-backdrop')"
                            >
                            ...
                            <vibe:sheet 
                                ...
                                :closeOnOutsideClick="true" 
                                :defaultSize="300"
                                class="shadow-2xl z-40"
                                @close-sheet.window="backdropOpen = false"
                            >
                                <vibe:sheet.header class="flex items-center justify-between">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-border bg-card shadow-2xs mt-2">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-muted/50 text-xs font-semibold uppercase tracking-wider text-muted-foreground border-b border-border">
                                <tr>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_sub') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_sub_desc') }}</th>
                                </tr>
                            </thead>
                ...
                <div class="space-y-2">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-border bg-card shadow-2xs mt-2">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-muted/50 text-xs font-semibold uppercase tracking-wider text-muted-foreground border-b border-border">
                                <tr>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_prop') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_type') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_default') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_desc') }}</th>
                                </tr>
                            </thead>
                ...
                <div class="space-y-2">
                    ...
                    <div class="overflow-x-auto rounded-xl border border-border bg-card shadow-2xs mt-2">
                        <table class="w-full text-left text-sm">
                            <thead class="bg-muted/50 text-xs font-semibold uppercase tracking-wider text-muted-foreground border-b border-border">
                                <tr>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_event') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_payload') }}</th>
                                    <th class="px-4 py-3">{{ __('docs/sheet.api.th_event_desc') }}</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-border font-mono text-xs">
