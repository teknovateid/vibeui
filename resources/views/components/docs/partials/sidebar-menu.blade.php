<vibe:nav {{ $attributes->twMerge(['class' => 'p-2 gap-1']) }} pinnable maxpin="5">
    <vibe:button variant="ghost" class="p-2 sm:hidden transition-colors" @click="$dispatch('toggle-sheet', 'sidebar-menu')">
        <div class="flex items-center justify-center">
            <!-- Icon when expanded -->
            <svg class="size-6 block group-data-[state=minified]/sheet:hidden" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="1.5">
            ...
            <!-- Icon when minified -->
            <svg class="size-6 hidden group-data-[state=minified]/sheet:block" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="1.5" class="solar solar-square-alt-arrow-left-outline">
