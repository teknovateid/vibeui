            ...
            <vibe:header class="bg-transparent! border-none!" size="sm">
                ...
                <vibe:header.actions class="items-center h-full relative">
                    ...
                    <vibe:dropdown keyboard>
                        <x-slot:trigger>
                            <vibe:avatar size="md" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Name" class="cursor-pointer border-2" />
                        </x-slot:trigger>
