            ...
            <vibe:header class="bg-transparent! border-none" size="sm" x-data>
                ...
                <vibe:header.actions class="items-center h-full relative">
                    ...
                    <vibe:button variant="ghost" class="p-2 relative rounded-full" x-data="{
                        ...
                        <svg x-show="isFullscreen" class="size-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" style="display: none;">
                            <path d="M4 14h6v6" />
                            <path d="M20 10h-6V4" />
                            <path d="M14 10l7-7" />
                            <path d="M10 14l-7 7" />
